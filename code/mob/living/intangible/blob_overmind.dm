/mob/living/intangible/blob_overmind
	...
	Stat()
		...
		stat(null, " ")
		stat(null, "--Blob--")
		stat(null, "Bio Points: [round(bio_points)]/[bio_points_max]")
		//debuff active
		...
		stat(null, "Blob Size: [length(blobs)]")
		stat(null, "Total spreads: [total_placed]")
		stat(null, "Evo Points: [evo_points]")
		stat(null, "Next Evo Point at size: [next_evo_point]")
		stat(null, "Total spreads needed for additional point: [next_pity_point]")
		stat(null, "Living nuclei: [nuclei.len]")
		stat(null, "Unplaced extra nuclei: [extra_nuclei]")
		stat(null, "Next Extra Nucleus at size: [next_extra_nucleus]")
